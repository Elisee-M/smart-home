...
const NotificationPanel = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Current Status Card */}
      <Card className={`p-6 transition-all duration-300 ${isWaterAlert(currentLevel) 
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground font-orbitron">Current Water Level</h3>
              <p className="text-3xl font-bold text-foreground">{isFinite(currentLevel) ? currentLevel.toFixed(1) : '0.0'}%</p>
            </div>
          </div>
        ...
        {isWaterAlert(currentLevel) && (
          <div className="mt-4 p-3 bg-destructive/10 border border-destructive/30 rounded-lg">
            <p className="text-destructive font-medium">⚠️ Water level is too high! Level is above 80% threshold - potential overflow risk.</p>
          </div>
        )}
      </Card>
        ...
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground font-orbitron">Water Level Notifications</h3>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="font-medium text-foreground">
                            Water Level: {isFinite(reading.level) ? reading.level.toFixed(1) : '0.0'}%
                          </p>
